...
/* Category Scrolling Label Bar */
.cat-bar { background: var(--bg-app); border-bottom: 1px solid var(--border-ui); padding: 10px 0; overflow-x: auto; white-space: nowrap; scrollbar-width: none; margin-bottom: 20px; }
